export const translations = {
    nl: {
        ...
        // === NIEUWE VERKORTE IFCC VERTALINGEN (NL) ===
        ifccPageTitle: "IFCC Events",
        ifccAboutTitle: "Over het project",
        ifccAboutDesc: "IFCC Events is een compleet platform bestaande uit een Laravel/Filament backend en een Expo mobiele applicatie. Het stelt organisaties in staat om congressen, presentaties en interactieve plattegronden naadloos te beheren en te presenteren aan bezoekers.",
        ifccAboutList1: "Filament CMS voor content- en kanaalbeheer",
        ifccAboutList2: "Dynamische Expo app met offline caching",
        ifccAboutList3: "Gepubliceerd in de App Store & Play Store",
        ifccFeaturesTitle: "Kernonderdelen",
        ifccDatabaseTitle: "Backend & API",
        ifccDatabaseDesc: "Centraal beheer van alle data.",
        ifccMobileTitle: "Mobiele App",
        ifccMobileDesc: "Interactieve ervaring voor bezoekers.",
        ifccTechnologiesTitle: "Technologieën",
        ifccBackendGithub: "Backend GitHub",
        ifccExpoGithub: "Expo GitHub",
        ifccDatabaseStructureTitle: "Database structuur",

        ifccBackendTitle: "Ontwikkeling: Backend (Filament)",
        ifccBackendCard1Title: "API & Databeheer",
        ifccBackendCard1Desc: "Opbouw van resources voor artikelen, sprekers en presentaties. Gegevens worden via een beveiligde REST API ontsloten naar de app.",
        ifccBackendCard2Title: "Auth & Rechten",
        ifccBackendCard2Desc: "Toegangsbeheer via QR-codes (Laravel Sanctum) en Spatie Permission voor rollen zoals Admin, Editor en Officer.",
        ifccBackendCard3Title: "Page-Maker & Kaarten",
        ifccBackendCard3Desc: "Complexe pagina's en dynamische menu's opbouwen via datablokken, plus een tool om afbeeldingen om te zetten in interactieve 2D-kaarten.",

        ifccFrontendTitle: "Ontwikkeling: Frontend (Expo)",
        ifccFrontendCard1Title: "Dynamische Interface",
        ifccFrontendCard1Desc: "De app genereert schermen op basis van dynamische componenten (headings, afbeeldingen, paragrafen) uit de API.",
        ifccFrontendCard2Title: "Offline Caching",
        ifccFrontendCard2Desc: "Met stale-while-revalidate logica blijft eerder ingeladen content ook zonder stabiele internetverbinding soepel werken.",
        ifccFrontendCard3Title: "Navigatie & QR",
        ifccFrontendCard3Desc: "Interactieve plattegronden voor oriëntatie en een QR-scanner om afgeschermde meetings of sprekersinformatie te openen.",

        ifccStoreDesignTitle: "Publicatie & Design",
        ifccDesignCard1Title: "Iteratief Ontwerp",
        ifccDesignCard1Desc: "Ontworpen in nauw overleg met Digital Designers via meerdere feedbackrondes voor optimale UX/UI.",
        ifccDesignCard1Link: "Bekijk het Figma Ontwerp",
        ifccStoreCard2Title: "App Store & Play Store",
        ifccStoreCard2Desc: "Cloud builds uitgevoerd met EAS. Na het doorlopen van testfases (TestFlight/Internal Tracks) en compliance checks succesvol gelanceerd op beide platformen.",

        ifccLiveLinksTitle: "Live applicaties",
        ifccWebsiteLink: "Website",
        ifccAdminLink: "Admin Portal",
        ifccAppStoreLink: "App Store",
        ifccPlayStoreLink: "Google Play",
        ifccBackLink: "← Terug naar projecten"
    },
...
I’m 20 years old and an enthusiastic developer with a strong passion for building web applications and apps. I’m always eager to learn and grow, whether that means picking up new skills or improving existing ones. I'm really looking forward to what my internship has to offer and everything I can learn from it along the way.`,
        ...
        // === NIEUWE VERKORTE IFCC VERTALINGEN (EN) ===
        ifccPageTitle: "IFCC Events",
        ifccAboutTitle: "About the project",
        ifccAboutDesc: "IFCC Events is a comprehensive platform consisting of a Laravel/Filament backend and an Expo mobile application. It enables organizations to seamlessly manage and present conferences, presentations, and interactive floor plans to attendees.",
        ifccAboutList1: "Filament CMS for content and channel management",
        ifccAboutList2: "Dynamic Expo app with offline caching",
        ifccAboutList3: "Published on the App Store & Play Store",
        ifccFeaturesTitle: "Core Features",
        ifccDatabaseTitle: "Backend & API",
        ifccDatabaseDesc: "Central management of all data.",
        ifccMobileTitle: "Mobile App",
        ifccMobileDesc: "Interactive experience for attendees.",
        ifccTechnologiesTitle: "Technologies",
        ifccBackendGithub: "Backend GitHub",
        ifccExpoGithub: "Expo GitHub",
        ifccDatabaseStructureTitle: "Database structure",

        ifccBackendTitle: "Development: Backend (Filament)",
        ifccBackendCard1Title: "API & Data Management",
        ifccBackendCard1Desc: "Building resources for articles, speakers, and presentations. Data is securely served to the app via a REST API.",
        ifccBackendCard2Title: "Auth & Permissions",
        ifccBackendCard2Desc: "Access management via QR codes (Laravel Sanctum) and Spatie Permission for roles like Admin, Editor, and Officer.",
        ifccBackendCard3Title: "Page-Maker & Maps",
        ifccBackendCard3Desc: "Building complex pages and dynamic menus via data blocks, plus a tool to convert images into interactive 2D maps.",

        ifccFrontendTitle: "Development: Frontend (Expo)",
        ifccFrontendCard1Title: "Dynamic Interface",
        ifccFrontendCard1Desc: "The app generates screens based on dynamic components (headings, images, paragraphs) from the API.",
        ifccFrontendCard2Title: "Offline Caching",
        ifccFrontendCard2Desc: "Using stale-while-revalidate logic, previously loaded content remains available even without a stable internet connection.",
        ifccFrontendCard3Title: "Navigation & QR",
        ifccFrontendCard3Desc: "Interactive floor plans for orientation and a QR scanner to unlock restricted meetings or speaker info.",

        ifccStoreDesignTitle: "Publication & Design",
        ifccDesignCard1Title: "Iterative Design",
        ifccDesignCard1Desc: "Designed in close collaboration with Digital Designers through multiple feedback rounds for optimal UX/UI.",
        ifccDesignCard1Link: "View the Figma Design",
        ifccStoreCard2Title: "App Store & Play Store",
        ifccStoreCard2Desc: "Cloud builds executed using EAS. Successfully launched on both platforms after test phases (TestFlight/Internal Tracks) and compliance checks.",

        ifccLiveLinksTitle: "Live applications",
        ifccWebsiteLink: "Website",
        ifccAdminLink: "Admin Portal",
        ifccAppStoreLink: "App Store",
        ifccPlayStoreLink: "Google Play",
        ifccBackLink: "← Back to projects"
    }
};
